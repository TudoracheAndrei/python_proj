...
def main():
    with sync_playwright() as p:
        ...
        df.to_excel(r'C:\Users\Default.DESKTOP-H6HQDSS\Desktop\Proiecte\CloudFinity\hotels_list.xlsx', index=False)
        df.to_csv(r'C:\Users\Default.DESKTOP-H6HQDSS\Desktop\Proiecte\CloudFinity\hotels_list.csv', index=False)
